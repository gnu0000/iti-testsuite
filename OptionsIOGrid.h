#if !defined(AFX_OPTIONSIOGRID_H__64D6CE45_F3F2_11D2_8A7F_00105A21C878__INCLUDED_)
#define AFX_OPTIONSIOGRID_H__64D6CE45_F3F2_11D2_8A7F_00105A21C878__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000\

// OptionsIOGrid.h : header file
//
//-----------------------------------------------------------------------
...
/////////////////////////////////////////////////////////////////////////////
// COptionsIOGrid window

class COptionsIOGrid : public COptionsCommonGrid
{
// Construction
public:
	COptionsIOGrid();
...
public:
	...
	void SaveData ();
	void InsertRow ();
	void SetGridData (COptionsIOGrid& srcGrid);


// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(COptionsIOGrid)
